 ...
 *------------------------------------------------------------------------ */
(function (w, j) {
  const l = 'enumerator is disposed'
  const q = 'single:sequence contains more than one element.'
  const a = false
  const b = null
  const e = true
  const g = {
  ...
  const d = {
    createLambda: function (a) {
      ...
      if (typeof a === i.String) {
        if (a == '') return g.Identity
          ...
          const n = Array.prototype.join.call(f, ',')
    ...
    defineProperty: Object.defineProperties != b ? function (c, b, d) {
  ...
  c.from = function (j) {
    ...
    return new c(function () {
      ...
      return new f(function () {
        for (const a in j) {
          const c = j[a] !(c instanceof Function) && Object.prototype.hasOwnProperty.call(j, a) && b.push({
            key: a,
            value: c
          })
        }
  ...
  c.repeat = function (a, d) {
    return d != b ? c.repeat(a).take(d) : new c(function () {
      return new f(g.Blank, function () {
    ...
    return new c(function () {
      ...
      return new f(function () {
        ...
        while (e) {
          ...
          const f = c.from(j).selectMany(function (a) {
            return g(a)
          })
          if (!f.any()) return a
          else {
  ...
  c.prototype.selectMany = function (g, e) {
    ...
    return new c(function () {
      ...
      return new f(function () {
        ...
        if (i === j) {
          if (!k.moveNext()) return a
        }
        do {
          if (i == b) {
            const f = g(k.current(), l++)
    ...
    if (b.length <= 1) return new n(this, b)
      ...
      return new c(function () {
        ...
        return new f(function () {
          ...
          while (c.moveNext()) {
            if (b(c.current(), g++)) return this.yieldReturn(c.current())
          }
          return a
        }, function () {
          d.dispose(c)
  ...
  c.prototype.zip = function () {
    const i = arguments
    const e = d.createLambda(arguments[arguments.length - 1])
    const g = this
    if (arguments.length == 2) {
      ...
      return new c(function () {
        ...
        let h = 0
        return new f(function () {
          const b = c.make(g).concat(c.from(i).takeExceptLast().select(c.from)).select(function (a) {
  ...
  c.prototype.merge = function () {
    ...
    return new c(function () {
      ...
      let g = -1
      return new f(function () {
        e = c.make(a).concat(c.from(b).select(c.from)).select(function (a) {
          return a.getEnumerator()
        }).toArray()
      }, function () {
        while (e.length > 0) {
  ...
  c.prototype.concat = function () {
    ...
    if (arguments.length == 1) {
      ...
      return new c(function () {
        let a
        return new f(function () {
          a = c.make(e).concat(c.from(h).select(c.from)).select(function (a) {
            return a.getEnumerator()
          }).toArray()
        }, function () {
          while (a.length > 0) {
  ...
  c.prototype.sequenceEqual = function (h, f) {
    f = d.createLambda(f)
    const g = this.getEnumerator()
    try {
      const b = c.from(h).getEnumerator()
      try {
        while (g.moveNext()) {
  ...
  p.create = function (a, d) {
    const c = new p(a.keySelector, a.descending, d)
  ...
  p.prototype.compare = function (e, f) {
    const a = this
    const c = d.compare(a.keys[e], a.keys[f])
  ...
  h.prototype.elementAt = function (a) {
    const b = this.getSource()
    return a >= 0 && a < b.length ? b[a] : c.prototype.elementAt.apply(this, arguments)
  }
  h.prototype.elementAtOrDefault = function (c, a) {
    if (a === j) a = b
    const d = this.getSource()
    return c >= 0 && c < d.length ? d[c] : a
  }
  ...
  n.prototype.getEnumerator = function () {
    const c = this.prevPredicate
    const e = this.prevSource
    let b
    return new f(function () {
      b = e.getEnumerator()
    }, function () {
      while (b.moveNext()) {
        if (c(b.current())) return this.yieldReturn(b.current())
      }
      return a
    }, function () {
      d.dispose(b)
  ...
  m.prototype.getEnumerator = function () {
    const e = this.prevPredicate
    const g = this.prevSelector
    const h = this.prevSource
    let c
    return new f(function () {
      c = h.getEnumerator()
    }, function () {
      while (c.moveNext()) {
        if (e == b || e(c.current())) return this.yieldReturn(g(c.current()))
      }
      return a
    }, function () {
      d.dispose(c)
  ...
  var r = (function () {
    ...
    l.prototype = {
      ...
      get: function (i) {
        const a = this
        const c = a.compareSelector(i)
        const g = h(c)
        if (!d(a.buckets, g)) return j
        for (let e = a.buckets[g], b = 0; b < e.length; b++) {
          const f = e[b]
      ...
      set: function (k, l) {
        const b = this
        const g = b.compareSelector(k)
        const j = h(g)
        if (d(b.buckets, j)) {
          for (let f = b.buckets[j], c = 0; c < f.length; c++) {
      ...
      contains: function (j) {
        const b = this
        const f = b.compareSelector(j)
        const i = h(f)
        if (!d(b.buckets, i)) return a
        for (let g = b.buckets[i], c = 0; c < g.length; c++) {
      ...
      remove: function (g) {
        const a = this
        const f = a.compareSelector(g)
        const e = h(f)
        if (!d(a.buckets, e)) return
        for (let b = a.buckets[e], c = 0; c < b.length; c++) {
