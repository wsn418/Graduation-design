    ...
    <section class="text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          ...
          <h2 class="font-weight-light mb-3 text-white">随心写作，自由表达</h2>
          <p>
            <a href="#" class="btn btn-primary my-2 text-white" @click.prevent="createOrLogin">开始写文章</a>
          </p>
        </div>
      </div>
    </section>
    <h4 class="font-weight-bold text-center mb-4 text-white">发现精彩</h4>
